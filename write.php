...
<body id="target">
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        echo '<li><a href="http://localhost:8080/opentutorials_webapp/index.php?id='.$row['id'].'">'.$row['title'].'</a></li>'."\n";
    }
    ?>
        </ol>
    </nav>
    <div id="control">
        ...
        <a href="http://localhost:8080/opentutorials_webapp/write.php">쓰기</a>
    </div>
    <article>
